...
export default function AudioDetailPage() {
  ...
  return (
    <div>
      <Link href="/audio" style={{ fontSize: '0.85rem', color: 'var(--p-text-3)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.4rem', marginBottom: '1rem' }}>
        <ArrowLeft size={16} /> Back to audio archive
      </Link>
